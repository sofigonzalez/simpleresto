...
class caja
{
	...
	*/
	...
	public function Create()
	{
		...
		$query ="INSERT INTO caja (`estado`,`observacion`,`fecha`) VALUES ('" . mysql_real_escape_string($this->getestado(),$dblink) . "','" . mysql_real_escape_string($this->getobservacion(),$dblink) . "',now());";
		mysql_query($query,$dblink);
